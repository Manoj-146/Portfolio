        ...
        <div id='Resume' className="py-10 flex flex-col md:flex-row items-center justify-around p-2 bg-[#808080] ">
            ...
            <div className= "w-1/2 flex flex-col">
                ...
                <div className='flex justify-center pt-5'>
                    <button className='w-[150px] h-10  bg-indigo-500 rounded-lg  hover:border-2 border-indigo-700 '><a className='w-full h-full text-white' href="https://drive.google.com/file/d/1b5MJxuk0eLDxyv9rLJA6uXtw7A6kFkzZ/view">Download</a></button>
                </div>
            </div>
        </div>
    );
