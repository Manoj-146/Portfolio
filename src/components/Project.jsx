        ...
        <div id="Project" className=" flex flex-col justify-around ">
            ...
            <div className='flex flex-col md:flex-row justify-around items-center rounded-2xl p-5'>
                <div className='font-bold relative m-4 '>
                    <img src={ecom} className='border-gray-600 border-2 shadow-2xs  w-4xl h-60 object-cover rounded-2xl' alt="" />
                    <div className=' cursor-pointer absolute opacity-0 w-full h-full hover:opacity-80 duration-500 top-0 left-0 right-0 bottom-0 bg-black bg-opacity-50 flex flex-col items-center justify-center'>
                        ...
                        <a target="_blank" href='https://github.com/Manoj-146/React-website' className='text-black  bg-gray-50 px-10 rounded-2xl py-2 border-2 border-gray-800'>Goto</a>
                    </div>
                </div>
                <div className='font-bold relative m-4 '>
                    <img src={todo} className=' border-gray-600 border-2 w-4xl h-60 object-cover rounded-2xl' alt="" />
                    <div className='cursor-pointer absolute opacity-0 w-full h-full hover:opacity-80 duration-500 top-0 left-0 right-0 bottom-0 bg-black bg-opacity-50  flex flex-col items-center justify-center'>
                ...
                <div className='font-bold relative m-4 '>
                    <img src={portfolio} className=' border-gray-600 border-2 w-4xl h-60 object-cover rounded-2xl' alt="" />
                    <div className='cursor-pointer absolute opacity-0 w-full h-full hover:opacity-80 duration-500 top-0 left-0 right-0 bottom-0 bg-black bg-opacity-50 flex flex-col items-center justify-center'>
                        <p className='p-5 text-white  text-2xl '>This is ecommerce website that i have built for sample using tech stack java, springboot, React.js, Mysql</p>
                        <a target="_blank" href='https://manoj-m-portfolio.vercel.app/' className='text-black  bg-gray-50 px-10 rounded-2xl py-2 border-2 border-gray-800'>Goto</a>
                    </div>
                </div>
            </div>
        </div>
